...
**📷 Filtered Visuals Preview:**

***Quarter 3 Insights***

Focused visualizations displaying sales and performance data limited to Q3 (July–September) for detailed seasonal analysis.

![image](https://github.com/user-attachments/assets/4de21995-64d9-484f-b299-61dafee6006a)

***Category: Clothing***

Dashboard filtered to show performance specific to the Clothing category, highlighting product-level trends and category contribution.
